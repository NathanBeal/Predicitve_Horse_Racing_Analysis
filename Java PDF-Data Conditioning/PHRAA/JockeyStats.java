...
public class JockeyStats
{
    ...
    ArrayList<ArrayList<Double>> formattedDoubleData = new ArrayList<ArrayList<Double>>();
    ...
    {
        JockeyStats demo = new JockeyStats();
        String fileExt = "SAR 17-19"; //"3-15-20 AQU";
        demo.run(fileExt);
    }
