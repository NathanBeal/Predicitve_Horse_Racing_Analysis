...
public class TestSet
{
    ...
    public static void main() throws IOException 
    {
        ...
        String[] docs = new String[] {"3-1-20 AQU Race 9"};
        demo.run(docs[0], 8);
    }
    
    public void readFromDataLog()
    {
        String textFile = "";
        try (Scanner scan = new Scanner(new FileReader("Horse Info.txt"))) 
        {
            StringBuilder sb = new StringBuilder();
            while(scan.hasNext()) 
            {
                String currentStr = scan.next();
                String indivChar = currentStr.split(" ")[0];
                        
                if(indivChar.equals("$"))
                {
                    dataLog.add(sb.toString());
    ...
    public void run(String testFileExt, int docIndex) throws IOException 
    {
        System.out.println("");
        System.out.println("Developing Test Set CSV:");
        File myFile = new File("C:/Users/natha/Desktop/Machine Learning/1. Left Off/PHRA/Race Test Data/" + testFileExt + ".pdf");
        ...
        {
            System.out.println("    - Processing pdf file(s)");
    ...
    public void writeToCSV(int docIndex)
    {
        //System.out.println("HERE");
        Collections.shuffle(formattedData);
        String newTextFile = "Test Set" + "" + Integer.toString(docIndex) + ".csv";
        String fullLiteral = "C:/Users/natha/Desktop/PHRAA/Generated Testing Data/" + newTextFile;
        try (PrintWriter writer = new PrintWriter(new FileWriter(fullLiteral, false))) 
        {
            StringBuilder sb = new StringBuilder();
            ...
            System.out.println("    - Finished Writing to CSV (Test Set)");    
            writer.flush();
            writer.close();
        } catch (IOException e) {
          System.out.println(e.getMessage());
    ...
    public ArrayList<String> refreshHorseList(String currHorse, double place, double numberOfRaceHorses, String dist, boolean firstRace, String[] lines, int lowerBound, int upperBound)
    {
        ...
        if(allHorses.size() != 0 )
        {
            ...
            if(tripped == false)
            {
                ...
                returnList.add(nd); returnList.add(Integer.toString(sr)); returnList.add(Integer.toString(sr));
            }else{
