 ...
 */
public class NonCleanProcessor
{
    ...
    public static void main() throws IOException 
    {
        ...
        NonCleanProcessor demo = new NonCleanProcessor();
        demo.run("Jan'19-Feb'20", docs, dv);
    }
    ...
    public void run(String fileExt, String[] testFilesExt, ArrayList<String> desiredVariables) throws IOException 
    {
        ...
        String newFile = "equibaseTestDoc";
        File myFile = new File("C:/Users/natha/Desktop/PHRA/" + newFile + ".pdf");
    ...
    public boolean checkDocument(String[] lines)
    {
        ...
        {
            String[] currentLineSegs = lines[i].split(" ");
            if(currentLineSegs[0].equals("Copyright") && currentLineSegs[2].equals("Equibase") 
            && i < 20)
            {
                System.out.println("EMPTY PAGE DETECTED");
                return false;
            }
        }
    ...
    public ArrayList<String> refreshHorseList(String currHorse, double place, double numberOfRaceHorses, String dist, boolean firstRace, String[] lines, int lowerBound, int upperBound)
    {
        ...
        if(allHorses.size() != 0 )
        {
            ...
            if(tripped == false)
            {
                ...
                returnList.add(nd); returnList.add("30"); returnList.add("30");
            }else{
