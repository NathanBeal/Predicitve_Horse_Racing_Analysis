...
/**
 * Write a description of class TestSetGeneration here.
 *
 * @author (Nathan Beal)
 * @version (1.0.0 - 12/16/20)
 */
public class TestSetGeneration
{
    long t1; long t2;
    int pageCount = 0;
    ...
    public TestSetGeneration(){}

    public static void main() throws IOException 
    {
        String FILE = "3-1-20 AQU Race 4";
        
        TestSetGeneration demo = new TestSetGeneration();
        demo.run(FILE);
    }
    
    public void run(String fileExt) throws IOException 
    {
        System.out.println("Developing Testing Set CSV: ");
        t1 = System.currentTimeMillis();
        File myFile = new File("C:/Users/natha/Desktop/ML/AQU Testing/Indiv Races/" + fileExt + ".pdf");
        ...
        for (pageCount = 1; pageCount < lim; pageCount++)
        {
            ...
            if(isRaceData == true)
            {
                ...
                if(pageCount > (lim- (numberOfDesiredRaces + additionalGap)))
                {
    ...
    public int calcAdditionalGap(int numPages, String[] pages)
    {
        ...
        for (pageCount = 1; pageCount < lim; pageCount++)
        {
            ...
            if(isRaceData == false)
            {
                badPageIndex.add(pageCount);
            }
        }
        
        for(int i = 0; i < badPageIndex.size(); i++)
        {
            ...
            System.out.print(badPageIndex.get(i) + ", ");
       
            
            if(badPageIndex.get(i) >= lim - numberOfDesiredRaces)
            {
                gap++;
            }
        }
    ...
    public void writeToCSV()
    {
        ...
        try (PrintWriter writer = new PrintWriter(new File("Testing.csv"))) 
        {
            ...
            //VARIABLES
            sb.append("date,"); sb.append("raceNum,"); sb.append("hName,"); sb.append("jName,"); sb.append("odds,"); sb.append("fav,");sb.append("pastPos,");  sb.append("trifecta,");
            sb.append('\n');
